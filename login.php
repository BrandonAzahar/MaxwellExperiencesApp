...
<head>
    ...
    <title>Login - Maxwell Experiences</title>
...
<body>
                    ...
                    <div class="login-card">
                        <div class="login-header">
                            <?php if (file_exists(LOGO_PATH)): ?>
                                <img src="imagenes/logo Maxwell Experiences.png" alt="Logo Maxwell" class="login-logo">
                            <?php else: ?>
                                <div class="login-logo d-flex align-items-center justify-content-center bg-white rounded-circle mx-auto floating-heart-container" style="width: 120px; height: 120px;">
                                    <i class="bi bi-heart-fill animate-heartbeat" style="font-size: 3rem;"></i>
                                    <i class="bi bi-heart-fill floating-heart floating-heart-1"></i>
                                    <i class="bi bi-heart-fill floating-heart floating-heart-2"></i>
                                    <i class="bi bi-heart-fill floating-heart floating-heart-3"></i>
                                </div>
                            <?php endif; ?>
                            <h4 class="mb-1 fw-bold">Maxwell Experiences</h4>
    ...
    <footer class="footer-login">
        <div class="container">
            <p class="mb-0">
                © <?php echo date('Y'); ?> Maxwell Experiences<br>
                NIT: <?php echo ''; ?> | Registro: <?php echo ''; ?>
            </p>
        </div>
    </footer>
