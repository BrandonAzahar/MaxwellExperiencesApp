...
define('COMPANY_NAME', 'Maxwell Experiences');
...
define('COMPANY_EMAIL', 'info@maxwellexperiences.com');

// ============================================
// CONFIGURACIÓN DE IMPUESTOS
// ============================================

// Monto mínimo para retención de renta
...
define('BASE_URL', '/MaxwellExperiences2.0/');

// Rutas de directorios
define('UPLOADS_PATH', BASE_PATH . '/uploads/');
define('PDF_PATH', BASE_PATH . '/pdfs/');
define('LOGO_PATH', BASE_PATH . '/imagenes/logo Maxwell Experiences.png');
...
// Nombre de la sesión
define('SESSION_NAME', 'MaxwellExperiences_SESSION');
